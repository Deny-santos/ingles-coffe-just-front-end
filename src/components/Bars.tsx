...
const Bars = (props: Props) => {
    ...
    return (
        <div className={` 
            duration-700 flex flex-col absolute top-0  py-4 overflow-hidden
            ${showBars ? "left-0" : "left-[-1000px]"} min-h-screen bg-blue-600 w-[80%] md:w-[500px] z-20
        `}>
            <div className='ml-2 ' onClick={handleShowMenu}>
                <MyToggleButton  />
            </div>
